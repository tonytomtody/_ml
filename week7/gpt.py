#!/usr/bin/env python3
"""
microgpt - A minimal GPT implementation in pure Python, no dependencies.
Based on Andrej Karpathy's microgpt: https://karpathy.github.io/2026/02/12/microgpt/
"""
...
BOS = len(uchars)  # Beginning of Sequence special token
